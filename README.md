...
```ts
//  one line
const name: string = "Baki Abdullah";
...
-  ### `String` : We can implicitly Define a type of a variable in `Typescript` as `string`
   ...
   ```ts
   let fullName: string = "Baki Abdullah";
...
friends = ["Baki Abdullah", "Safi Islam"];
friends.push("Safi Islam");
...
isBoolean = "Baki Abdullah"; // Errors : type 'boolean' is not assignable to type boolean[].
isBoolean = ["Safi Islam", "rakib hossain", 20]; // Errors : Type 'string & number' is not assignable to type boolean
```
...
myTuple = ["Safi Islam", 20, false];
myTuple[0] = "Baki Abdullah";
myTuple[1] = 20;
myTuple[2] = true;
myTuple[2] = true;
...
myTuple[3] = "Safi Islam"; // Errors : Type '"Safi Islam"' is not assignable to type 'undefined'.
```
...
user.name 'Safi Islam' // Errors: Cannot assign to 'name' because it is a read-only
...
-  ### Tuple in Type Alias:
   ...
   const user1: TUserData = ["Baki Abdullah", 21, false];
   const user2: TUserData = ["Safi Islam", 20, false];
...
-  Example :
   ...
   const user1 : TUserName = 'Baki Abdullah";
   ...
   // output1: isAvail1 =Baki Abdullah
...
const userName: TNullAbleString = "Baki Abdullah";
...
-  Example :
   ...
   // assign array :
   random = ["Baki Abdullah", "Safi Islam", 20, 40];
